        ...
        <div className="sidebar" style={{}}>
          ...
          >
            ...
            <ul className="product-categories">
              ...
              <li className="cat-item cat-item-19 current-cat">
          ...
          >
            ...
            <div className="widget-filter">
              <div className="attr-filter attr-filter-price">
                <form
                  method="get"
                  action="https://necshop.7uptheme.net/product-category/accessories/"
                >
                  <h3>price</h3>
                  <div
                    id="slider-range"
                ...
                <ul className="list-color-filter">
                  <li className="">
                    <a
                      ...
                      href="https://necshop.7uptheme.net/product-category/accessories/?pa_color=black"
                    >
                      <span />
                    </a>
                  </li>
                  <li className="">
                    <a
                      ...
                      href="https://necshop.7uptheme.net/product-category/accessories/?pa_color=blue"
                    >
                      <span />
                    </a>
                  </li>
                  <li className="">
                    <a
                      ...
                      href="https://necshop.7uptheme.net/product-category/accessories/?pa_color=gray"
                    >
                      <span />
                    </a>
                  </li>
                  <li className="">
                    <a
                      ...
                      href="https://necshop.7uptheme.net/product-category/accessories/?pa_color=green"
                    >
                      <span />
                    </a>
                  </li>
                  <li className="">
                    <a
                      className="color-red"
                      href="https://necshop.7uptheme.net/product-category/accessories/?pa_color=red"
                    >
                      <span />
                    </a>
                  </li>
                  <li className="">
                    <a
                      ...
                      href="https://necshop.7uptheme.net/product-category/accessories/?pa_color=white"
                    >
                      <span />
                    </a>
                  </li>
              ...
              <div className="attr-filter attr-filter-size size-filter">
                ...
                <ul className="list-size-filter">
                  <li className="">
                    <a href="https://necshop.7uptheme.net/product-category/accessories/?pa_size=l">
                      L
                    </a>
                  </li>
                  <li className="">
                    <a href="https://necshop.7uptheme.net/product-category/accessories/?pa_size=m">
                      M
                    </a>
                  </li>
                  <li className="">
                    <a href="https://necshop.7uptheme.net/product-category/accessories/?pa_size=s">
                      S
                    </a>
                  </li>
                  <li className="">
                    <a href="https://necshop.7uptheme.net/product-category/accessories/?pa_size=xl">
                      XL
                    </a>
                  </li>
                </ul>
            ...
            <div className="row">
              <div className="col-md-3 col-sm-12 col-xs-12">
                <div className="view-type">
                  <label>View</label>
                  <a
                    href="https://necshop.7uptheme.net/product-category/accessories/?type=grid"
                    className="grid-type active"
                  >
                    <span className="lnr lnr-dice" />
                  </a>
                  <a
                    href="https://necshop.7uptheme.net/product-category/accessories/?type=list"
                    className="list-type "
                  >
                  ...
                  <div className="tool-box per-page-box">
                    ...
                    <div className="shop-current-number select-box">
                      ...
                      <ul className="per-page-list">
                        <li>
                          <a href="https://necshop.7uptheme.net/product-category/accessories/?number=6">
                            6
                          </a>
                        </li>
                        <li>
                          <a href="https://necshop.7uptheme.net/product-category/accessories/?number=9">
                            9
                          </a>
                        </li>
                        <li>
                          <a href="https://necshop.7uptheme.net/product-category/accessories/?number=12">
                            12
                          </a>
                        </li>
                        <li>
                          <a href="https://necshop.7uptheme.net/product-category/accessories/?number=18">
                            18
                          </a>
                        </li>
                        <li>
                          <a href="https://necshop.7uptheme.net/product-category/accessories/?number=24">
                            24
                          </a>
                        </li>
                        <li>
                          <a href="https://necshop.7uptheme.net/product-category/accessories/?number=48">
                            48
                          </a>
                        </li>
                      </ul>
          ...
          <div className="content-product-list">
            <ul className="list-product grid-view row">
                ...
                <div className="product-item">
                  <div className="product-thumb">
                    ...
                    <div className="product-more-link product ">
                      <a
                        href="/product-category/accessories/?add-to-cart=119"
                        rel="nofollow"
                        data-product_id={119}
                      ...
                      <a
                        href="/product-category/accessories/?add_to_wishlist=119"
              ...
              <li className="col-md-4 col-sm-6 col-xs-12 ">
                <div className="product-item">
                  <div className="product-thumb">
                    ...
                    <div className="product-more-link product ">
                      <a
                        href="/product-category/accessories/?add-to-cart=125"
                        rel="nofollow"
                        data-product_id={125}
                      ...
                      <a
                        href="/product-category/accessories/?add_to_wishlist=125"
                        className="add_to_wishlist wishlist-link"
                        rel="nofollow"
                        data-product-id={125}
                      >
              ...
              <li className="col-md-4 col-sm-6 col-xs-12 ">
                <div className="product-item">
                  <div className="product-thumb">
                    ...
                    <div className="product-more-link product ">
                      <a
                        href="/product-category/accessories/?add-to-cart=127"
                        rel="nofollow"
                        data-product_id={127}
                      ...
                      <a
                        href="/product-category/accessories/?add_to_wishlist=127"
                        className="add_to_wishlist wishlist-link"
                        rel="nofollow"
                        data-product-id={127}
                      >
              ...
              <li className="col-md-4 col-sm-6 col-xs-12 break-item">
                <div className="product-item">
                  <div className="product-thumb">
                    ...
                    <div className="product-more-link product ">
                      <a
                        href="/product-category/accessories/?add-to-cart=121"
                        rel="nofollow"
                        data-product_id={121}
                      ...
                      <a
                        href="/product-category/accessories/?add_to_wishlist=121"
                        className="add_to_wishlist wishlist-link"
                        rel="nofollow"
                        data-product-id={121}
                      >
              ...
              <li className="col-md-4 col-sm-6 col-xs-12 ">
                <div className="product-item">
                  <div className="product-thumb">
                    ...
                    <div className="product-more-link product ">
                      <a
                        href="/product-category/accessories/?add-to-cart=118"
                        rel="nofollow"
                        data-product_id={118}
                      ...
                      <a
                        href="/product-category/accessories/?add_to_wishlist=118"
                        className="add_to_wishlist wishlist-link"
                        rel="nofollow"
                        data-product-id={118}
                      >
                ...
                <div className="product-item">
                  <div className="product-thumb">
                    ...
                    <div className="product-more-link product ">
                      ...
                      <a
                        href="/product-category/accessories/?add_to_wishlist=207"
                        className="add_to_wishlist wishlist-link"
                        rel="nofollow"
                        data-product-id={207}
                      >
              ...
              <li className="col-md-4 col-sm-6 col-xs-12 break-item">
                <div className="product-item">
                  <div className="product-thumb">
                    ...
                    <div className="product-more-link product ">
                      <a
                        href="/product-category/accessories/?add-to-cart=124"
                        rel="nofollow"
                        data-product_id={124}
                      ...
                      <a
                        href="/product-category/accessories/?add_to_wishlist=124"
                        className="add_to_wishlist wishlist-link"
                        rel="nofollow"
                        data-product-id={124}
                      >
              ...
              <li className="col-md-4 col-sm-6 col-xs-12 ">
                <div className="product-item">
                  <div className="product-thumb">
                    ...
                    <div className="product-more-link product ">
                      <a
                        href="/product-category/accessories/?add-to-cart=126"
                        rel="nofollow"
                        data-product_id={126}
                      ...
                      <a
                        href="/product-category/accessories/?add_to_wishlist=126"
                        className="add_to_wishlist wishlist-link"
                        rel="nofollow"
                        data-product-id={126}
                      >
              ...
              <li className="col-md-4 col-sm-6 col-xs-12 ">
                <div className="product-item">
                  <div className="product-thumb">
                    ...
                    <div className="product-more-link product ">
                      <a
                        href="/product-category/accessories/?add-to-cart=123"
                        rel="nofollow"
                        data-product_id={123}
                      ...
                      <a
                        href="/product-category/accessories/?add_to_wishlist=123"
                        className="add_to_wishlist wishlist-link"
                        rel="nofollow"
                        data-product-id={123}
                      >
              ...
              <li className="col-md-4 col-sm-6 col-xs-12 break-item">
                <div className="product-item">
                  <div className="product-thumb">
                    ...
                    <div className="product-more-link product ">
                      <a
                        href="/product-category/accessories/?add-to-cart=120"
                        rel="nofollow"
                        data-product_id={120}
                      ...
                      <a
                        href="/product-category/accessories/?add_to_wishlist=120"
                        className="add_to_wishlist wishlist-link"
                        rel="nofollow"
                        data-product-id={120}
                      >
              ...
              <li className="col-md-4 col-sm-6 col-xs-12 ">
                <div className="product-item">
                  <div className="product-thumb">
                    <a
                      href="https://necshop.7uptheme.net/product/raumfeld-wireless/"
                      className="product-thumb-link"
                    >
                      <img
                        width={330}
                        height={330}
                        src="https://necshop.7uptheme.net/wp-content/uploads/2016/05/3-330x330.jpg"
                        className="attachment-330x330 size-330x330 wp-post-image"
                        alt=""
                        srcSet="https://necshop.7uptheme.net/wp-content/uploads/2016/05/3-330x330.jpg 330w, https://necshop.7uptheme.net/wp-content/uploads/2016/05/3-150x150.jpg 150w, https://necshop.7uptheme.net/wp-content/uploads/2016/05/3-300x300.jpg 300w, https://necshop.7uptheme.net/wp-content/uploads/2016/05/3-768x768.jpg 768w, https://necshop.7uptheme.net/wp-content/uploads/2016/05/3-600x600.jpg 600w, https://necshop.7uptheme.net/wp-content/uploads/2016/05/3-550x550.jpg 550w, https://necshop.7uptheme.net/wp-content/uploads/2016/05/3-128x128.jpg 128w, https://necshop.7uptheme.net/wp-content/uploads/2016/05/3-370x370.jpg 370w, https://necshop.7uptheme.net/wp-content/uploads/2016/05/3-120x120.jpg 120w, https://necshop.7uptheme.net/wp-content/uploads/2016/05/3-100x100.jpg 100w, https://necshop.7uptheme.net/wp-content/uploads/2016/05/3-70x70.jpg 70w, https://necshop.7uptheme.net/wp-content/uploads/2016/05/3.jpg 1000w"
                        sizes="(max-width: 330px) 100vw, 330px"
                      />
                    </a>
                    <div className="product-more-link product ">
                      <a
                        href="/product-category/accessories/?add-to-cart=131"
                        rel="nofollow"
                        data-product_id={131}
                        data-product_sku="10a0015"
                        data-quantity={1}
                        className="add_to_cart_button addcart-link product_type_simple"
                      >
                        <span className="lnr lnr-cart" />
                      ...
                      <a
                        href="/product-category/accessories/?add_to_wishlist=131"
                        className="add_to_wishlist wishlist-link"
                        rel="nofollow"
                        data-product-id={131}
                      >
                      ...
                      <a
                        href="https://necshop.7uptheme.net?action=yith-woocompare-add-product&id=131"
                        className="product-compare compare compare-link"
                        data-product_id={131}
                      >
                        <span className="lnr lnr-paw" />
                  ...
                  <div className="product-info">
                    <h3 className="product-title">
                      <a href="https://necshop.7uptheme.net/product/raumfeld-wireless/">
                        Raumfeld Wireless
                      </a>
                    </h3>
                    <div className="product-price">
              ...
              <li className="col-md-4 col-sm-6 col-xs-12 ">
                <div className="product-item">
                  <div className="product-thumb">
                    <a
                      href="https://necshop.7uptheme.net/product/silicondust-hdhomerun/"
                      className="product-thumb-link"
                    >
                      <img
                        width={330}
                        height={330}
                        src="https://necshop.7uptheme.net/wp-content/uploads/2016/05/1-330x330.jpg"
                        className="attachment-330x330 size-330x330 wp-post-image"
                        alt=""
                        srcSet="https://necshop.7uptheme.net/wp-content/uploads/2016/05/1-330x330.jpg 330w, https://necshop.7uptheme.net/wp-content/uploads/2016/05/1-150x150.jpg 150w, https://necshop.7uptheme.net/wp-content/uploads/2016/05/1-300x300.jpg 300w, https://necshop.7uptheme.net/wp-content/uploads/2016/05/1-768x768.jpg 768w, https://necshop.7uptheme.net/wp-content/uploads/2016/05/1-600x600.jpg 600w, https://necshop.7uptheme.net/wp-content/uploads/2016/05/1-370x370.jpg 370w, https://necshop.7uptheme.net/wp-content/uploads/2016/05/1-120x120.jpg 120w, https://necshop.7uptheme.net/wp-content/uploads/2016/05/1-100x100.jpg 100w, https://necshop.7uptheme.net/wp-content/uploads/2016/05/1-266x266.jpg 266w, https://necshop.7uptheme.net/wp-content/uploads/2016/05/1-550x550.jpg 550w, https://necshop.7uptheme.net/wp-content/uploads/2016/05/1-70x70.jpg 70w, https://necshop.7uptheme.net/wp-content/uploads/2016/05/1.jpg 1000w"
                        sizes="(max-width: 330px) 100vw, 330px"
                      />
                    </a>
                    <div className="product-more-link product ">
                      ...
                      <a
                        href="/product-category/accessories/?add_to_wishlist=136"
                        className="add_to_wishlist wishlist-link"
                        rel="nofollow"
                        data-product-id={136}
                      >
                      ...
                      <a
                        href="https://necshop.7uptheme.net?action=yith-woocompare-add-product&id=136"
                        className="product-compare compare compare-link"
                        data-product_id={136}
                      >
                        <span className="lnr lnr-paw" />
                  ...
                  <div className="product-info">
                    <h3 className="product-title">
                      <a href="https://necshop.7uptheme.net/product/silicondust-hdhomerun/">
            ...
            <div className="shop-paginav text-right">
              ...
              <a
                ...
                href="https://necshop.7uptheme.net/product-category/accessories/page/2/"
              >
                2
              </a>
              <a
